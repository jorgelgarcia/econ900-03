...
\noindent Throughout Econ 900-02 and Econ 900-03, three two estimators have been considered: OLS, IV, and ML. This estimators have a common feature: They exploit moment conditions motivated either by an algorithm (e.g.,\ first-order conditions of minimization or maximization problems) or an assumption (e.g.,\ an orthogonality condition).\\
...
\begin{align}
	...
	& = \bm{0}
\end{align}
\noindent which has $\bm{\hat{\beta}}^{\text{OLS}}$. In Econ 900-02, an analogous instrumental-variable estimator was formulated to exploit an orthogonality condition over an an instrumental variable $z_{i}$.\\
