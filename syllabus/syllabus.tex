...
\noindent \textbf{Class Schedule.} The first class meets on 10/13/2021. The last regular-schedule class meets on 11/19/2021. There are two additional lectures on 11/08/2021, 11/15/2021, and 11/22/2021 from 10:00 a.m. to 11:30 a.m. This totals 14 classes of one hour and a half. An additional class will be schedule if needed. The final exam is on 11/22/2021 from 8:30 a.m. to 8:30 p.m. (take-home exam).\\

\noindent \textbf{Office Hours with Instructor.} Fridays from 12:00 p.m. to 1:30 p.m., \textit{by Zoom.} The link for the weekly office hours is posted on Canvas. The office hours will be open so that anyone enrolled in the class can join them and stay connected during the time indicated. If you require a private time-slot, please e-mail me so that we can schedule it.\\
